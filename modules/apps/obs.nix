    ...
    modules = {
      homeManager = {
        ...
        obs-shared = {
          ...
          key = "nix-config#homeManager.obs-shared";
        };
      };
      nixos.obs =
        { config, ... }:
        {
          ...
          home-manager.sharedModules = [ self.modules.homeManager.obs ];
        };
    };
    modules.nixos.obs-flatpak.home-manager.sharedModules = [
      self.modules.homeManager.obs-flatpak
    ];
  };
}

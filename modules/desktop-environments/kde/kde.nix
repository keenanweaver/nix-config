{ self, inputs, ... }:
{
  flake = {
    modules = {
          ...
          }:
          {
            ...
            programs.plasma = {
              ...
              kwin = {
                ...
                nightLight = {
                  enable = true;
                  location = builtins.mapAttrs (_: toString) self.lib.site.location;
                  mode = "times";
                  temperature = {
                    day = 6500;
                    night = 3300;
      ...
      nixos.kde =
        { config, pkgs, ... }:
        {
          ...
          home-manager.sharedModules = [ self.modules.homeManager.kde ];
          nixpkgs.overlays = [
            (final: prev: {
    ...
    modules.nixos.plasma-manager.home-manager.sharedModules = [
      self.modules.homeManager.plasma-manager
    ];
  };
  flake-file.inputs = {

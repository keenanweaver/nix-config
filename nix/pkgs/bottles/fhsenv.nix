...
let
  fhsEnv = {
    ...
    # Necessary for GStreamer to function: https://github.com/NixOS/nixpkgs/issues/311004#issuecomment-2138181633
    profile = ''
      export GST_PLUGIN_SYSTEM_PATH_1_0=/lib/gstreamer-1.0:/lib32/gstreamer-1.0
    '';
  };
in
symlinkJoin {
